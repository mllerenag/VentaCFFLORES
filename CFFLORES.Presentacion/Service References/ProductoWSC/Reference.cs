...
namespace CFFLORES.Presentacion.ProductoWSC {
    ...
    public interface IProducto {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(CFFLORES.Presentacion.ProductoWSC.ProductoInexistente), Action="http://tempuri.org/IProducto/ObtenerProductoProductoInexistenteFault", Name="ProductoInexistente", Namespace="http://schemas.datacontract.org/2004/07/CFFLORES.WebService.Errores")]
        CFFLORES.Presentacion.ProductoWSC.EProducto[] ObtenerProducto(string codigobarra, string nombre, string tipo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProducto/ObtenerProducto", ReplyAction="http://tempuri.org/IProducto/ObtenerProductoResponse")]
        System.Threading.Tasks.Task<CFFLORES.Presentacion.ProductoWSC.EProducto[]> ObtenerProductoAsync(string codigobarra, string nombre, string tipo);
        ...
        CFFLORES.Presentacion.ProductoWSC.EProducto[] ListarProducto();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProducto/ListarProducto", ReplyAction="http://tempuri.org/IProducto/ListarProductoResponse")]
        System.Threading.Tasks.Task<CFFLORES.Presentacion.ProductoWSC.EProducto[]> ListarProductoAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IProductoChannel : CFFLORES.Presentacion.ProductoWSC.IProducto, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ProductoClient : System.ServiceModel.ClientBase<CFFLORES.Presentacion.ProductoWSC.IProducto>, CFFLORES.Presentacion.ProductoWSC.IProducto {
        ...
        public CFFLORES.Presentacion.ProductoWSC.EProducto[] ObtenerProducto(string codigobarra, string nombre, string tipo) {
            return base.Channel.ObtenerProducto(codigobarra, nombre, tipo);
        }
        
        public System.Threading.Tasks.Task<CFFLORES.Presentacion.ProductoWSC.EProducto[]> ObtenerProductoAsync(string codigobarra, string nombre, string tipo) {
            return base.Channel.ObtenerProductoAsync(codigobarra, nombre, tipo);
        }
        
        public CFFLORES.Presentacion.ProductoWSC.EProducto[] ListarProducto() {
            return base.Channel.ListarProducto();
        }
        
        public System.Threading.Tasks.Task<CFFLORES.Presentacion.ProductoWSC.EProducto[]> ListarProductoAsync() {
